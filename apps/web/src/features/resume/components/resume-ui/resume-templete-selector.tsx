...
const ResumeTempleteSelector = ({setSelectedTemplete}) => {
    ...
    return (
        <div style={{
            ...
            <div className='m-4 grid grid-cols-2 md:grid-cols-4 gap-6'>
                {
                    resumeTempletes.map((r, idx) => (
                        <div key={idx}>
                            ...
                            <button onClick={()=>selectTemplete(r.title)} className="rounded-md hover:bg-blue-900 hover:scale-95 duration-300 cursor-pointer my-2 text-white bg-emerald-500 px-2 py-0.5 flex items-center justify-center gap-2 text-sm capitalize w-full">click to select<SparkleIcon size={16} /></button>
